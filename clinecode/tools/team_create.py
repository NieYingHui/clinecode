...
class TeamCreateTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from clinecode.teams.backend_detect import BackendDetectionError
        ...
        coordinator_note = ""
        from clinecode.teams.coordinator import is_coordinator_mode
        if is_coordinator_mode(self._enable_coordinator_mode):
            from clinecode.agents.tool_filter import apply_coordinator_filter
