...
PROJECT_AGENTS_DIR = ".clinecode/agents"
USER_AGENTS_DIR = "~/.clinecode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("clinecode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from clinecode.agents.parser import parse_frontmatter, _validate_agent_meta
