...
_OPTIONS = [
    ...
    ("Tell ClineCode what to change", PlanChoice.FEEDBACK),
]
...
class InlinePlanWidget(Vertical, can_focus=True):
    ...
    BINDINGS = [
        ...
        Binding("shift+tab", "c", "Approve+Feedback", priority=True),
    ]
    ...
    def _build_content(self) -> str:
        lines = [
            "\n [bold #875fff]ClineCode has written up a plan and is ready to execute. "
