...
from clinecode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from clinecode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from clinecode.agents.trace import TraceManager, TraceNode
from clinecode.agents.task_manager import BackgroundTask, TaskManager
from clinecode.agents.notification import format_task_notification, inject_task_notifications
from clinecode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".clinecode" / "agents"
...
class TestAgentToolParams:
    def test_required_fields(self):
        from clinecode.tools.agent_tool import AgentToolParams
